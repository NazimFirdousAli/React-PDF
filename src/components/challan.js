...
//         </div>
//         <div>
//           <div id="divFeePaymentBankCopy" style={{ border: 'medium solid grey', fontFamily: '"Times New Roman", Times, serif', fontSize: 'smaller', width: '32%', float: 'left', height: '700px', position: 'relative' }}>
...
//               </div>
//               <div id="divBankLogo_Bank" style={{ width: '100%', textAlign: 'center' }}>
//                 <img id="imgbankLogo_Bank" src={banklogo} style={{ borderWidth: '0px', width: '70%' }} />
//               </div>
//               <div style={{ textAlign: 'center' }}>
//                 <b>Account #
//                   <span id="lblBank_Account_No_Bank">0042-7901-4053-03 </span></b>
//               </div>
//               <br />
//               <div>
//                 <div>
//                   <div style={{ width: '32%', float: 'left', fontSize: 'medium' }}>
//                     Deposit Slip #
//                   </div>
//                   <div style={{ borderStyle: 'ridge', borderWidth: 'thin', width: '65%', float: 'right', font: 'bolder', fontWeight: 'bolder', fontSize: 'medium' }}>
//                     &nbsp;
//                     <span id="lblChallan_No_Bank">000000000085657</span>
//                   </div>
//                 </div>
...
//                     <b>
//                       <span id="lblChallan_Date_Bank">18-Mar-2022</span></b>
//                   </div>
//                 </div>
//                 <span id="lblMessage" />
//               </div>
...
//                 <div style={{ width: '65%', float: 'right' }}>
//                   <b>
//                     <span id="lblBank_Account_Title_Bank">FM Public School</span></b>
//                 </div>
//               </div>
//               <div style={{ width: '100%', overflow: 'hidden' }}>
//                 <div className="style-caption">
...
//               </div>
//             </div>
//             <div style={{ position: 'absolute', bottom: '5px', fontSize: 'xx-small', width: '97%' }}>
...
//             </div>
//           </div>
//           <div id="divFeePaymentInstituteCopy" style={{ border: 'medium solid grey', fontFamily: '"Times New Roman", Times, serif', fontSize: 'smaller', width: '32%', display: 'inline-block', marginLeft: '4px', height: '700px', position: 'relative' }}>
//             <div style={{ display: "flex", justifyContent: "center" }}>
//               <img id="imgLogoInstitute" src={logo} style={{ height: '100px', borderWidth: '0px' }} />
//             </div>
//             <div style={{ marginLeft: '2%', marginRight: '2%' }}>
//               <div style={{ textAlign: 'center' }}>
//                 <h5>BANK VOUCHER (School Copy)</h5>
//               </div>
//               <div id="divBankLogo_Institute" style={{ width: '100%', textAlign: 'center' }}>
//                 <img id="imgBankLogo_Institute" src={banklogo} style={{ borderWidth: '0px', width: '70%' }} />
//               </div>
//               <div style={{ textAlign: 'center' }}>
//                 <b>Account #
//                   <span id="lblBank_Account_No_Institute">0042-7901-4053-03 </span></b>
//               </div>
//               <br />
//               <div>
//                 <div>
...
//                   <div style={{ borderStyle: 'ridge', borderWidth: 'thin', width: '65%', float: 'right', font: 'bolder', fontWeight: 'bolder', fontSize: 'medium' }}>
//                     &nbsp;
//                     <span id="lblChallan_No_Institute">000000000085657</span>
//                   </div>
//                 </div>
//                 <div style={{ width: '100%', overflow: 'hidden' }}>
//                 </div>
...
//                   <div style={{ width: '65%', float: 'right' }}>
//                     <b>
//                       <span id="lblChallan_Date_Institute">18-Mar-2022</span></b>
//                   </div>
//                 </div>
//                 <span id="Label1" />
//               </div>
...
//                 <div style={{ width: '65%', float: 'right' }}>
//                   <b>
//                     <span id="lblBank_Account_Title_Institute">FM Public School</span></b>
//                 </div>
//               </div>
//               <div style={{ width: '100%', overflow: 'hidden' }}>
//                 <div className="style-caption">
...
//             </div>
//           </div>
//           <div id="divFeePaymentStudentCopy" style={{ border: 'medium solid grey', fontFamily: '"Times New Roman", Times, serif', fontSize: 'smaller', width: '32%', display: 'inline-block', marginLeft: '4px', height: '700px', position: 'relative' }}>
//             <div style={{ display: "flex", justifyContent: "center" }}>
//               <img id="imgLogoStudent" src={logo} style={{ height: '100px', borderWidth: '0px' }} />
//             </div>
//             <div style={{ marginLeft: '2%', marginRight: '2%' }}>
//               <div style={{ textAlign: 'center' }}>
//                 <h5>BANK VOUCHER (Student Copy)</h5>
//               </div>
//               <div id="divBankLogo_Student" style={{ width: '100%', textAlign: 'center' }}>
//                 <img id="imgBankLogo_Student" src={banklogo} style={{ borderWidth: '0px', width: "70%" }} />
//               </div>
//               <div style={{ textAlign: 'center' }}>
//                 <b>Account #
//                   <span id="lblBank_Account_No_Student">0042-7901-4053-03 </span></b>
//               </div>
//               <br />
//               <div>
//                 <div>
//                   <div className="style-caption" style={{ width: '32%', float: 'left', fontSize: 'medium' }}>
//                     Deposit Slip #
//                   </div>
//                   <div style={{ borderStyle: 'ridge', borderWidth: 'thin', width: '65%', float: 'right', font: 'bolder', fontWeight: 'bolder', fontSize: 'medium' }}>
//                     &nbsp;
//                     <span id="lblChallan_No_Student" style={{ display: 'inline-block', borderStyle: 'None' }}>000000000085657</span>
//                   </div>
//                 </div>
//                 <div style={{ width: '100%', overflow: 'hidden' }}>
//                 </div>
...
//                   <div style={{ width: '65%', float: 'right' }}>
//                     <b>
//                       <span id="lblChallan_Date_Student">18-Mar-2022</span></b>
//                   </div>
//                 </div>
//                 <span id="Label2" />
//               </div>
...
//                 <div style={{ width: '65%', float: 'right' }}>
//                   <b>
//                     <span id="lblBank_Account_Title_Student">FM Public School</span></b>
//                 </div>
//               </div>
//               <div style={{ width: '100%', overflow: 'hidden' }}>
//                 <div className="style-caption">
